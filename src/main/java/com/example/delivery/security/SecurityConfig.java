...
import com.example.delivery.filter.MyAuthenticationFilter;
import com.example.delivery.filter.MyAuthorizationFilter;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests().antMatchers(POST  , "/api/restaurants/**").hasAnyAuthority("ROLE_ADMIN");
